...
手動驗收入口：[`docs/frontend-specs/test/booking-backend-integration-manual.md`](../docs/frontend-specs/test/booking-backend-integration-manual.md)
...
| **FA-2** | Token 過期／401 導回登入 | 待做 | 加固：ApiClient／頁面遇到 401 清狀態並開登入 |
