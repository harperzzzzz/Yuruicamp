# AdminPermissionsPage Spec

**Status:** Draft
**Category:** Page
**Design Ref:** N/A - derived from existing source file `admin/partials/permissions.html`

---

## Overview

Admin permissions partial with employee table, employee modal, super admin flag, and permission matrix. Use for employee access control. Keep permission rows explicit and auditable.
...
export interface AdminPermissionsPageData {
  title: string;
  sourcePath: 'admin/partials/permissions.html';
  keyAreas: string[];
  blocks?: ContentBlock[];
}
...
export interface AdminPermissionsPageProps {
  ...
  data: AdminPermissionsPageData; // Initial page content, records, or mounted section metadata.
  ...
  onRefresh?: (sourcePath: 'admin/partials/permissions.html') => void;
...
|---------|-------|-------------|
| Default | `shell="admin"` | Matches the current `admin/partials/permissions.html` layout and shared CSS. |
...
<AdminPermissionsPage
  shell="admin"
  data={{
    title: 'AdminPermissionsPage',
    sourcePath: 'admin/partials/permissions.html',
    keyAreas: 'employeeTableBody, employeeModal, permissionMatrixBody'.split(', '),
  }}
/>
```
...
- Source file: `admin/partials/permissions.html`.
- Shared CSS source: `admin/css/admin.css`.
- Shared components: admin/dashboard.html shell and admin partial loader.
- Key UI areas: employeeTableBody, employeeModal, permissionMatrixBody.
