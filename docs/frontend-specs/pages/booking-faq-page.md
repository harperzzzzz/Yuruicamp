...
**Status:** Draft
**Category:** Page
**Design Ref:** N/A - derived from existing source file `booking/pages/booking-faq.html`

---

## Overview

Booking FAQ page with payment, cancellation, damage, check-in, and delivery sections. Use for reservation support content. Keep anchor navigation and readable content blocks.
...
export interface BookingFaqPageData {
  title: string;
  sourcePath: 'booking/pages/booking-faq.html';
  keyAreas: string[];
  blocks?: ContentBlock[];
}

export interface BookingFaqPageProps {
  // Required props
  shell: 'booking'; // Page shell variant used by this source page.
  data: BookingFaqPageData; // Initial page content, records, or mounted section metadata.
  ...
  onRefresh?: (sourcePath: 'booking/pages/booking-faq.html') => void;
...
|---------|-------|-------------|
| Default | `shell="booking"` | Matches the current `booking/pages/booking-faq.html` layout and shared CSS. |
...
<BookingFaqPage
  shell="booking"
  data={{
    title: 'BookingFaqPage',
    sourcePath: 'booking/pages/booking-faq.html',
    keyAreas: 'payment, cancellation, damage, checkin, delivery'.split(', '),
  }}
/>
```
...
- Source file: `booking/pages/booking-faq.html`.
...
- Key UI areas: payment, cancellation, damage, checkin, delivery.
