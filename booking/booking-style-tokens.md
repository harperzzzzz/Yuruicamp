...
| `--yc-surface-muted` | `#f4f0e8` | Disabled / readonly surface |
| `--yc-oat` | `#e8e0d5` | 中性分隔與柔和底色 |
| `--yc-border` | `#d8cfc3` | 預設邊線 |
| `--yc-border-soft` | `rgb(216 207 195 / 64%)` | 低對比邊線 |
| `--yc-border-strong` | `#b9b0a3` | 表單、重要邊線 |
| `--yc-sage-mist` | `#eef2ec` | 選取、hover soft 背景 |
| `--yc-sage-soft` | `#dce5da` | chip、tag、filter 背景 |
| `--yc-sage-light` | `#b7c3b3` | hover border、低強度品牌色 |
| `--yc-sage` | `#8f9d8b` | brand hover |
...
| `--yc-cta-hover` | `#d4c27e` | CTA hover |
| `--yc-cta-active` | `#c4af62` | CTA active |
| `--yc-on-cta` | `#4a4537` | CTA 文字 |
| `--yc-gold-text` | `#6a5a2e` | 金色語意文字，不作為 CTA 文字 |
| `--yc-text` | `#3e473d` | 主要文字 |
| `--yc-text-secondary` | `#625e56` | 次要文字 |
| `--yc-text-muted` | `#7b756d` | 輔助文字 |
| `--yc-text-subtle` | `#9a958d` | disabled / metadata |
...
| `--yc-success-line` | `#a8bea0` | 成功狀態邊線 |
| `--yc-success` | `#73816e` | 成功主色 |
| `--yc-success-text` | `#4f624a` | 成功文字 |
| `--yc-warning-soft` | `#f4ece2` | 警告背景 |
| `--yc-warning-line` | `#cdaa9c` | 警告邊線 |
| `--yc-warning` | `#9a7455` | 警告主色 |
| `--yc-warning-dark` | `#6b4d32` | 警告文字 |
| `--yc-error-soft` | `#f4e7e4` | 錯誤背景 |
| `--yc-error-line` | `#d4a29d` | 錯誤邊線 |
| `--yc-error` | `#a65f58` | 錯誤主色 |
| `--yc-error-text` | `#8a4842` | 錯誤文字 |
| `--yc-info-soft` | `#eef2ec` | 資訊背景 |
| `--yc-info-line` | `#b7c3b3` | 資訊邊線 |
| `--yc-info` | `#62705d` | 資訊文字 / icon |
...
| `--bk-primary-hover` | `var(--yc-sage)` |
| `--bk-primary-light` | `var(--yc-sage-mist)` |
...
| `--bk-accent` | `var(--yc-sage)` |
| `--bk-gold` | `var(--yc-gold-text)` |
...
* Input、select、textarea 使用 `--yc-control-height-md`、`--yc-radius-control`、`--yc-border-strong`。
* Focus 使用 `--yc-focus-ring`。
* Error 使用 `--yc-error-soft`、`--yc-error-line`、`--yc-error-text`，並在欄位附近顯示文字。
...
* Filter chip hover：`--yc-sage-mist` + `--yc-sage-light`。
